...
void Model::loadModel(std::string const &path)
{
    ...
    {
        std::string msg = std::string("ERROR: Failed to load model: ") + importer.GetErrorString();
...
std::vector<Mesh::Texture> Model::loadMaterialTextures(aiMaterial *mat, aiTextureType type, std::string name) {
    std::vector<Mesh::Texture> textures;
